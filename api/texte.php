<!-- <?php
    ...
    "poster"=>"{$path}poster_fallout.jpg","banner"=>"imagens/meowtopia.jpg","trailer"=>"...");
    ...
    "poster"=>"{$path}poster_mk1.jpg","banner"=>"imagens/omega collapse.jpg","trailer"=>"...");
    ...
    "poster"=>"{$path}poster_fc24.jpg","banner"=>"imagens/crimson Curse.jpg","trailer"=>"...");
