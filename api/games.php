<?php 
    ...
    $game[1] = array(
      ...
      "logo" => "http://localhost/aula/TechAcademy2/imagens-jogo/omegacollapse.jpeg",
      "jogo" => "http://localhost/aula/TechAcademy2/game/omegacollaps/index.html",
      );
    ...
    $game[4] = array(
      ...
      "title" => "CyberGun",
        ...
        "jogo" => "http://localhost/aula/TechAcademy2/game/CYBERGUN/index.html"
        );  
             // gabriel 2
    $game[5] = array(
      "id" => 5,
   "title" => "Flyinchicken",
     ...
     "logo" => "http://localhost/aula/TechAcademy2/imagens-jogo/flyingchicken.jpeg",
     "jogo" => "http://localhost/aula/TechAcademy2/game/FlyanpChicken/flyingchicken/index.html",
     );  
