<?php 
    ...
    $game[1] = array(
      ...
      "logo" => "https://buyhubofc.000webhostapp.com/aula/TechAcademy2/imagens-jogo/omegacollapse.jpeg",
      "jogo" => "https://buyhubofc.000webhostapp.com/aula/TechAcademy2/game/omegacollaps/index.html",
      );
    ...
    $game[2] = array(
      ...
      "logo" => "https://buyhubofc.000webhostapp.com/aula/TechAcademy2/imagens-jogo/meowtopia.jpeg",
      "jogo" => "https://buyhubofc.000webhostapp.com/aula/TechAcademy2/game/meowtopia/index.html",
      );
    ...
    $game[3] = array(
      ...
      "logo" => "https://buyhubofc.000webhostapp.com/aula/TechAcademy2/imagens-jogo/crimsoncurse.png",
      "jogo" => "",
      );
          // gabriel
    $game[4] = array(
      ...
      "title" => "CyberGun",
        ...
        "logo" => "https://buyhubofc.000webhostapp.com/aula/TechAcademy2/imagens-jogo/cybergun.jpg",
        "jogo" => "https://buyhubofc.000webhostapp.com/aula/TechAcademy2/game/CYBERGUN/index.html"
        );  
             // gabriel 2
    $game[5] = array(
      "id" => 5,
   "title" => "Flyinchicken",
     ...
     "logo" => "https://buyhubofc.000webhostapp.com/aula/TechAcademy2/imagens-jogo/flyingchicken.jpeg",
     "jogo" => "https://buyhubofc.000webhostapp.com/aula/TechAcademy2/game/FlyanpChicken/flyingchicken/index.html",
     );  
