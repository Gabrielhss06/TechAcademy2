<?php 
    ...
    $game[1] = array(
      ...
      "logo" => "http://localhost/aula/TechAcademy2/aula/TechAcademy2/imagens-jogo/omegacollapse.jpeg",
      "jogo" => "http://localhost/aula/TechAcademy2/aula/TechAcademy2/game/omegacollaps/index.html",
      );
    ...
    $game[2] = array(
      ...
      "logo" => "http://localhost/aula/TechAcademy2/aula/TechAcademy2/imagens-jogo/meowtopia.jpeg",
      "jogo" => "http://localhost/aula/TechAcademy2/aula/TechAcademy2/game/meowtopia/index.html",
      );
    ...
    $game[3] = array(
      ...
      "logo" => "http://localhost/aula/TechAcademy2/aula/TechAcademy2/imagens-jogo/crimsoncurse.png",
      "jogo" => "",
      );
          // gabriel
    $game[4] = array(
      ...
      "title" => "CyberGun",
        ...
        "logo" => "http://localhost/aula/TechAcademy2/aula/TechAcademy2/imagens-jogo/cybergun.jpg",
        "jogo" => "http://localhost/aula/TechAcademy2/aula/TechAcademy2/game/CYBERGUN/index.html"
        );  
             // gabriel 2
    $game[5] = array(
      "id" => 5,
   "title" => "Flyinchicken",
     ...
     "logo" => "http://localhost/aula/TechAcademy2/aula/TechAcademy2/imagens-jogo/flyingchicken.jpeg",
     "jogo" => "http://localhost/aula/TechAcademy2/aula/TechAcademy2/game/FlyanpChicken/flyingchicken/index.html",
     );  
